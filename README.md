...
Thanks to TN for the main [repository](https://github.com/titaniumnetwork-dev/Ultraviolet-Static-Archive) base. Make sure to add credit to this repository and also to star it. Also this person is really bothered because this runs on a backend, so its not fully static. https://github.com/FoxMoss
